...
cv::Vec3f RayIntersection::interPos(RTCHit& h)
{
	int fID = h.primID;
	cv::Vec3f pp(0., 0., 0.);
	pp[0] = float((1. - h.u - h.v) * vertices[triangles[fID].v0].x + h.u * vertices[triangles[fID].v1].x + h.v * vertices[triangles[fID].v2].x);
	pp[1] = float((1. - h.u - h.v) * vertices[triangles[fID].v0].y + h.u * vertices[triangles[fID].v1].y + h.v * vertices[triangles[fID].v2].y);
	pp[2] = float((1. - h.u - h.v)* vertices[triangles[fID].v0].z + h.u * vertices[triangles[fID].v1].z + h.v * vertices[triangles[fID].v2].z);
	return pp;
}
